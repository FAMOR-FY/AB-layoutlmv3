...
from src.utils import utils, masking_generator
...
def main(args):
    ...
    encoder = load_model("/Users/huimuyu/Works/AB-VLP/layoutmv3_pretrain/data/encoder.pkl", device)
    ...
    for iter in range(0, len(ori_data), args.split_size):
        ...
        for i in range(len(split_data)):
            ...
            try:
                ...
                print(split_data.pop(i), e, flush=True)
